...
public class MultiImageSelectorFragment extends Fragment {
    ...
    public static final int ANDROID_SEVEN_REQUEST_CAMERA = 1111;
    // Single choice
    ...
    private File photoFile;//创建临时图片文件
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        } else if (requestCode == ANDROID_SEVEN_REQUEST_CAMERA) {
            if (resultCode == Activity.RESULT_OK) {
                if (photoFile != null) {
                    mCallback.onCameraShot(photoFile);
                }
            } else {
                // delete tmp file
                while (mTmpFile != null && mTmpFile.exists()) {
            ...
            if (intent.resolveActivity(getActivity().getPackageManager()) != null) {
                ...
                if (mTmpFile != null && mTmpFile.exists()) {
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                        ...
                        if (photoFile != null) {
                            Uri photoURI = FileProvider.getUriForFile(getActivity(), "me.nereo.fileprovider", photoFile);
    ...
    private File createPublicImageFile() throws IOException {
        ...
        Log.i("jason", "path:" + path.getAbsolutePath());
        String imageFileName = "JPEG_MED";
    ...
    private void requestPermission(final String permission, final String camera, String rationale, final int requestCode) {
            ...
            new AlertDialog.Builder(getContext())
                    ...
                    .setPositiveButton(R.string.mis_permission_dialog_ok, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            requestPermissions(new String[]{permission, camera}, requestCode);
                        }
                    })
