...
public class TutorialPageSuccessActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!getSharedPreferences(Constants.PREF_NAME, 0).getBoolean(getString(R.string.key_preset),false))
        {
            ...
            getModel().addAlarm(new Alarm(8, 0, (byte) 0, getString(R.string.startup_goal_weekly_days),0,"",false));
            getModel().addAlarm(new Alarm(9, 0, (byte) 0, getString(R.string.startup_goal_weekend),0,"",false));
