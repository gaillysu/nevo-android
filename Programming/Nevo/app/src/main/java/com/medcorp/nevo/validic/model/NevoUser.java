...
public class NevoUser {
    private String uid;  //auto generated by Nevo API, "0" means it is an anonymous user.
    ...
    private String lastValidicRoutineRecordID;//when user create/update the last routine validic record, save its to here
    private String validicUserAccessToken;//auto generated by validic API
    private String lastValidicSleepRecordID;//when user create/update the last sleep validic record, save its to here

    public NevoUser(String uid)
    {
        this.uid = uid;
    }
