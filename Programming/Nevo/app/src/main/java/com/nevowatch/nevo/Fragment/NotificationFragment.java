...
public class NotificationFragment extends Fragment implements OnSyncControllerListener, Switch.OnCheckedChangeListener{
    ...
    private void initListView(){
        ...
        mList.add(new NotificationItem(R.drawable.call_icon50, "电话", R.drawable.moreitem));
        mList.add(new NotificationItem(R.drawable.email_icon50, "邮件", R.drawable.moreitem));
        mList.add(new NotificationItem(R.drawable.facebook_icon50, "Facebook", R.drawable.moreitem));
        mList.add(new NotificationItem(R.drawable.sms_icon50, "短信", R.drawable.moreitem));
        mList.add(new NotificationItem(R.drawable.calendar_icon50, "日历", R.drawable.moreitem));
        mList.add(new NotificationItem(R.drawable.wechat_icon50, "微信", R.drawable.moreitem));
    }
