 ...
 */
public class SetNotificationLunarRequest extends BLERequestData {
    ...
    public SetNotificationLunarRequest(Context context, Map<Notification, Integer> applicationNotificationColorMap)
    {
